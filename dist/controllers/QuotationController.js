...
class QuotationController {
    ...
    static async getQuotationById(req, res) {
        let idQuotation = req.params.id;
        let quotation;
        try {
            quotation = await quotationRepository_1.quotationRepository.findOneOrFail({ where: { id: idQuotation } });
        }
        catch (error) {
    ...
    static async editQuotation(req, res) {
        ...
        let quotation;
        try {
            quotation = await quotationRepository_1.quotationRepository.findOneOrFail({ where: { id: id_quotation } });
        }
        catch (error) {
    ...
    static async deleteQuotation(req, res) {
        ...
        quotationRepository_1.quotationRepository.delete(idQuotation);
